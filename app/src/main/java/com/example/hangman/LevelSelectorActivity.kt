...
class LevelSelectorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val levels = rawWords.mapIndexed { index, w ->
            ...
            Level(
                name = "Level ${index + 1} - ${if (letters <= 4) getString(R.string.difficulty_easy) else if (letters <= 7) getString(R.string.difficulty_medium) else getString(R.string.difficulty_hard)}",
                word = w.uppercase(),
                letterCount = letters,
